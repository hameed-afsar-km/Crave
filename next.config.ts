    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://checkout.razorpay.com https://*.firebaseio.com https://*.googleapis.com https://apis.google.com",
              ...
              "frame-src 'self' https://checkout.razorpay.com https://crave-538c0.firebaseapp.com",
